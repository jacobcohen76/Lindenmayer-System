...
public class SemiConiferousPythagoreanTree
{
	...
	static String directory= "E:\\L-Systems\\Semi-Coniferous Pythagorean Tree\\frames\\";
	...
	public static void pythagorean_tree(double A, double B, double width, double height)
	{
		...
		B *= 180 / Math.PI;
		 FontMetrics fm = g2D.getFontMetrics();
	        String title = "Semi-Coniferous Pythagorean Tree";
		...
		try {
			File f = new File(directory + "Semi-Coniferous Pythagorean Tree - A = " + String.format("%.1f", A) + " B = " + String.format("%.1f", B) + " n = " + n + ".png");
			f.mkdirs();
